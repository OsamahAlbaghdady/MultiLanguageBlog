                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button class="dropdown-item" type="submit"><i class="fa fa-lock">logout</i></button>
                        </form>
                    </div>
                </li>
            </ul>
                        ...
                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            <a class="dropdown-item"
                                href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}"><i
                                    class="fa fa-user"></i> {{ $properties['native'] }}</a>
                        @endforeach
            ...
            <div class="tab-pane active" id="timeline" role="tabpanel">
                ...
                <div class="callout callout-warning m-a-0 p-y-1">
                    <div class="avatar pull-xs-right">
                        <img src="{{ asset('assets/admin/img/avatars/7.jpg') }}" class="img-avatar"
                ...
                <div class="callout callout-info m-a-0 p-y-1">
                    <div class="avatar pull-xs-right">
                        <img src="{{ asset('assets/admin/img/avatars/4.jpg') }}" class="img-avatar"
                            alt="admin@bootstrapmaster.com">
                    </div>
                    <div>Skype with
                        <strong>Megan</strong>
                ...
                <div class="callout callout-danger m-a-0 p-y-1">
                    ...
                    <div class="avatars-stack m-t-h">
                        <div class="avatar avatar-xs">
                            <img src={{ asset('assets/admin/img/avatars/2.jpg') }} class="img-avatar"
                                alt="admin@bootstrapmaster.com">
                        </div>
                        <div class="avatar avatar-xs">
                            <img src={{ asset('assets/admin/img/avatars/3.jpg') }} class="img-avatar"
                                alt="admin@bootstrapmaster.com">
                        </div>
                        <div class="avatar avatar-xs">
                            <img src={{ asset('assets/admin/img/avatars/4.jpg') }} class="img-avatar"
                        ...
                        <div class="avatar avatar-xs">
                            <img src={{ asset('assets/admin/img/avatars/5.jpg') }} class="img-avatar"
                                alt="admin@bootstrapmaster.com">
                        </div>
                        <div class="avatar avatar-xs">
                            <img src={{ asset('assets/admin/img/avatars/6.jpg') }} class="img-avatar"
                                alt="admin@bootstrapmaster.com">
                        </div>
                    </div>
                </div>
                ...
                <div class="callout callout-primary m-a-0 p-y-1">
                    ...
                    <div class="avatars-stack m-t-h">
                        ...
                        <div class="avatar avatar-xs">
                            <img src={{ asset('assets/admin/img/avatars/8.jpg') }} class="img-avatar"
                                alt="admin@bootstrapmaster.com">
                        </div>
                    </div>
                </div>
